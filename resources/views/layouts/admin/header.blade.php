    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                ...
                <!-- Counter - Alerts -->
                <span id="notify_count" class="badge badge-danger badge-counter">{{Auth::guard('admin')->user()->unreadNotifications->count() }}</span>+
            </a>
            <!-- Dropdown - Alerts -->
            <div  id="notify_push" class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                @empty
                <a class="dropdown-item text-center small text-gray-500" href="#">No Notification Yet</a>
